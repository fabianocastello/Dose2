...
############################# FRONT END STREAMLIT
    ...
    with st.expander('Primeira vez por aqui? Leia-Me!', expanded=False):
        ...
        st.write('💉 Criei este site, totalmente gratuito, para que possa ser usado pela população da cidade de São Paulo. A ideia nasceu porque porque eu mesmo passei por esta dor de ter que achar a minha vacina da segunda dose. Fui obrigado a ir a vários locais.')
